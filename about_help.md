...
教育智能体-高中信通版（SmartKB）是一个基于AI的智能问答平台，集成了云端知识库、本地RAG（检索增强生成）和智能体工作流等多种技术，为用户提供全方位的智能对话和知识管理服务。
...
- **用户注册管理**：管理员可注册新用户并分配角色

### 2. AI对话服务

- **云端知识库版**：基于DashScope云端服务的智能问答（云端智能体版）
...
- **图像理解**：支持JPG、PNG、GIF、BMP、TIFF、WebP等图像格式的智能识别和分析
- **文档处理**：支持PDF、Word、Excel、PowerPoint、TXT、CSV、JSON等多种文档格式
- **文件大小限制**：文档最大10MB，图像最大5MB
- **批量处理**：支持同时上传多个文件进行处理
- **文件摘要**：自动生成文件内容摘要用于上下文增强

### 4. 任务管理系统

- **任务创建**：管理员和教师可以创建任务（输入"提交[任务名]任务"）
- **任务提交**：学生可以将对话内容提交到指定任务（输入"完成"或"结束"）
- **智能筛选**：系统根据班级信息智能推荐相关任务
- **任务管理**：支持教师和管理员查看任务提交情况
- **汇总管理**：自动生成任务提交汇总文件
...
- **HTML文件管理**：管理员和教师可以上传、管理和删除HTML资源
- **HTML预览**：支持生成的HTML代码实时预览
- **资源分享**：便于教学资源的发布和展示
...
A: 在对话界面使用"版本"下拉菜单选择"本地知识库版"、"本地智能体版"或"云端智能体版"

## 功能特色

- **上下文增强**：勾选"上下文增强"选项可利用文件内容提供更精准的回答
- **智能任务分配**：系统根据班级信息智能推荐相关任务
- **多模型支持**：集成多种AI模型，满足不同场景需求
- **实时预览**：支持HTML代码实时预览和动画效果
- **用户友好**：简洁直观的界面设计，易于使用
